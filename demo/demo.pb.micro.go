...
type DemoService interface {
	Hello(ctx context.Context, in *Say, opts ...client.CallOption) (*Result, error)
}
...
func (c *demoService) Hello(ctx context.Context, in *Say, opts ...client.CallOption) (*Result, error) {
...
func (h *demoHandler) Hello(ctx context.Context, in *Say, out *Result) error {
